...
data.nextOperation = Object.assign(new Operation(), {
  name: '2002181378080010',
  targetQty: 1000,
  totalYield: 0,
  totalScrap: 0,
  targetCycleTime: 22
...
data.nextOperation.bomItems.set(0, {
  material: '5-6100000-5',
  pos: 0,
  quantity: 1,
  unit: 'm'
...
data.nextOperation.bomItems.set(1, {
  material: '5-6100000-9',
  pos: 1,
  quantity: 2,
  unit: 'm'
...
data.nextOperation.bomItems.set(2, {
  material: '5-6100000-2',
  pos: 2,
  quantity: 2,
  unit: 'PC'
